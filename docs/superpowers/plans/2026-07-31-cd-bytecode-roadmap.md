...
| M7-local | Reproducible LLVM-only, VM, parity, and module-link verification | Complete | Latest local gate: 110 lit (109 passed, 1 unsupported), parity 79/79, VM `73 + 3 + 8`, module-link direct/machine passed |
