...
| M7-local | Reproducible LLVM-only, VM, parity, and module-link verification | Complete | Latest local gate: 116 lit (115 passed, 1 unsupported), parity 85/85, VM `73 + 3 + 8`, module-link direct/machine passed |
