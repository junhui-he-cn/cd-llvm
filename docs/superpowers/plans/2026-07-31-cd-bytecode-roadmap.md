...
| M7-local | Reproducible LLVM-only, VM, parity, and module-link verification | Complete | Latest local gate: 118 lit (117 passed, 1 unsupported), parity 87/87, VM `73 + 3 + 8`, module-link direct/machine passed |
